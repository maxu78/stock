...
import com.mx.stock.util.HttpClientUtil;
...
public class WxBot {
    ...
    private void getUuid() {
        ...
        try {
            ...
            String path = url + "?appid=" + appid + "&fun=" + fun + "&lang=" + lang + "&_=" + System.currentTimeMillis();

            String responseContent = HttpClientUtil.sendHttpGet(path);
    ...
    private boolean checkLogin(String tip, long currentTimeMillis) {
        ...
        try {
            String loginIcon = "true";
            String path = "https://login.wx.qq.com/cgi-bin/mmwebwx-bin/login?loginicon=" + loginIcon + "&uuid=" + URLEncoder.encode(uuid, "UTF-8") +"&tip=" + tip + "&r=" + this.r() + "&_=" + currentTimeMillis;
